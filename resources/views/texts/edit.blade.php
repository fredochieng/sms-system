...
@section('content')
    <div class="box with-border">
              ...
              <div class="box-body">
                  	...
                  	<div class="col-md-12">
                    	{{Form::label('title', 'Title of your SMS / Campaign* ')}}
                         <div class="form-group">
                             {{Form::text('title', $text->text_title,['class'=>'form-control', 'placeholder'=>'Enter your Sms/Campaign Title', 'required'=>'required'])}}
                  ...
                  @if($text->from_source=='contact_list') checked @endif > 
                ...
                <div class="col-md-3">
                  ...
                  <input type="radio" name="contact_source" class="flat-red contact_source" value="csv_upload"
                   @if($text->from_source=='csv_upload') checked @endif
                ...
                <div style="display:none">
                  ...
                  <input type="radio" name="contact_source" class="flat-red contact_source" value="recepient_contacts"
                    @if($text->from_source=='recepient_contacts') checked @endif
                  >
                <i class="fa fa-fw fa-phone "></i> Enter Recipient Contacts
                  	...
                  	<div class="col-md-12 contact_method contact_list"  @if($text->from_source!='contact_list') style="display:none" @endif>
                    	{{Form::label('recepients_contact_list', 'Recepients From a  Contact List')}}
                         <div class="form-group">
                             
                             <input type="hidden" name="contact_list_sel" value="{{$text->contacts_id}}">
                 ...
                 <?php } ?>
                    	...
                    	<div class="col-md-12 contact_method csv_upload"  @if($text->from_source!='csv_upload') style="display:none" @endif>
                         @if($text->from_source=='csv_upload') 
                         	 <a href="/{{$text->contact_details->csv_file}}" class="btn btn-default btn-xs btn-flat">DOWNLOAD UPLOADED CSV</a> <BR><br>
          ...
          <button type="button" class="btn btn-info btn-sm btn-flat upload_csv_btn" data-toggle="modal" data-target="#modal-upload-csv"><strong><i class="fa fa-fw fa-upload"></i>UPLOAD CONTACTS FROM A CSV FILE</strong>
           ...
           <a href="" class="remove_uploaded_csv"> <span style="color:#E41114"><i class="fa fa-fw fa-close"></i></span></a>
                   ...
                   <div class="col-md-12 contact_method recepient_contacts"  @if($text->from_source!='recepient_contacts') style="display:none" @endif>
                    	{{Form::label('recepients_phone_nos', 'Recepients Phone Numbers with Country Code (Comma separated)')}}
                         <div class="form-group">
                             {{Form::textarea('recepients_phone_nos',  $text->recepient_contacts,['class'=>'form-control recepient_contacts', 'placeholder'=>'Comma separated Phone numbers e.g: 254713295853, 254123459789, 254987654321 '])}}
                        </div>
                  ...
                  <ul class="dropdown-menu shortcodes_ul" role="menu" style="padding: 0px 0; height:250px; overflow:auto">
                    ...
                    <div style="clear:both"></div>
                    	...
                    	{{Form::label('messageBody', 'Your message')}}
                         <div class="form-group">
                             {{Form::textarea('messageBody', $text->message,['class'=>'form-control', 'placeholder'=>'Enter your Sms/Campaign Title'])}}
     ...
     <div class="box-footer">
                <button type="submit" class="btn btn-success btn-flat"><strong><i class="fa fa-fw fa-share-square"></i> SAVE CHANGES</strong></button> &nbsp;
                 ...
                 <input type="hidden" class="send_contact_id" name="send_contact_id" value="{{$text->contacts_id}}">

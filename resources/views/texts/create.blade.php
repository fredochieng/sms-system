...
<div class="box with-border">
	...
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				{{Form::label('recepients_country', 'Select Recepients Country *')}}

				<div class="form-group">
					{{ Form::select('recepients_country', $countries,null, ['class' => 'form-control','placeholder'=>'--Select the country you are sending SMS to--']) }}
				</div>
			</div>
			@if($count == 'M')
			<div class="col-md-4">
				{{Form::label('Select department you are sending the SMS from ')}}
				<div class="form-group">
					<select class="form-control select2 user_department" name="user_department" required
						style="width: 100%;" tabindex="-1" aria-hidden="true">
						<option value="">Select department you are sending the SMS from</option>
			...
			@elseif($count == 'O')
			{{$dept_id}}
			<input type="hidden" name="user_department" class="user_department" value="{{$dept_id}}">
			@elseif($count == 'Z')
			<input type="hidden" name="user_department" class="user_department" value="{{$dept_id}}">
			@endif
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<label>
					<input type="radio" name="contact_source" class="flat-red contact_source"
						value="recepient_contacts">
		...
		<div class="row">
			<div class="col-md-12 contact_method contact_list">
				...
				<div class="form-group">
				 ...
				 ?>
						...
						<option value="<?php echo $contact->contacts_id?>"><?php echo $contact->contacts_title?>
						</option>
			...
			<div class="col-md-12 contact_method csv_upload">
				...
				<button type="button" class="btn btn-info btn-sm btn-flat upload_csv_btn" data-toggle="modal"
					data-target="#modal-upload-csv"><strong><i class="fa fa-fw fa-upload"></i>UPLOAD CONTACTS FROM A CSV
						FILE</strong>
				</button>
				<h4 class="uploaded_user_csv_contact" style="display:none">
					...
					<a href="" class="remove_uploaded_csv"> <span style="color:#E41114"><i
								class="fa fa-fw fa-close"></i></span></a>
		...
		<div class="row" style="padding-top:20px">
			...
			<div class="col-md-12">
				<span style="float:right; margin-right:100px; display:none" class="shortcodes">
					<div class="btn-group">
						<button type="button" class="btn  btn-flat btn-info dropdown-toggle btn-sm"
							data-toggle="dropdown"><strong>{&nbsp; }</strong></button>

						<ul class="dropdown-menu shortcodes_ul" role="menu"
							style="padding: 0px 0; height:250px; overflow:auto">
	...
	<div class="box-footer">
		...
		<button class="btn btn-info btn-flat preview"><strong><i class="fa fa-fw fa-tv"></i> VALIDATE & PREVIEW
				SMS</strong></button> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;

		<span class="submit_buttons">
			<button type="submit" class="btn btn-success btn-flat save"><strong><i class="fa fa-fw fa-share-square"></i>
					SUBMIT SMS</strong></button> &nbsp;
			...
			<div class="modal-body">
				...
				<form id="form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							{{ Form::checkbox('save_for_future_switch',null,null, array('id'=>'save_for_future_switch')) }}
							{{Form::label('save_for_future_switch', ' Save The imported contacts for future use')}}
						</div>
...
<div class="modal fade" id="preview_sms">
    ...
    border: 1px solid #e7f6ff;">
						...
						<h5><strong>TOTAL SMS CONTACTS: <br><span class="total_contacts" style="font-size:23px"></span>
							</strong> </h5>
					</div>
					...
					<div class="col-md-12">
						<p style="font-size:13px">Click on <strong>LOOK'S GOOD</strong> to close the preview screen then
							click on <strong>SUBMIT SMS</strong> button to Send.</p>
					</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary btn-flat pull-left looks_good"> <strong>LOOK'S
						GOOD</strong></button>
		 ...
		 contacts= $("#recepients_phone_nos").val();	 
      	 	...
      	 	e.preventDefault();
				...
				if( !$(".user_department").val() ) {
					 error_dis="yes";
					 errors=errors + "<p>Select Department</p>";
   				}

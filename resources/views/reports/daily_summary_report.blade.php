...
@section('title', 'Daily Summary Reports')
@section('content_header')

<h1>SMS Daily Summary Report - {{$date}}</h1>
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <h3 class="box-title"><strong>{{$country_name. '-'. $dept_name. ' ('. $date. ')'}} SMS Report
                            Chart</strong></h3>
    ...
    $(document).ready(function () {
        ...
        $("#exportBtn").on('click' , function(e) {    
            ...
            $.ajax({        
                ...
                data: {'_token':"{{ csrf_token() }}",'sent': parseInt(sent)} ,

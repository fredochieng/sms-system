	<strong>EXPORT REPORT: </strong>
            ...
            {!! Form::open(['action'=>'ReportsController@filtered_generate_excel','method'=>'POST','class'=>'form','enctype'=>'multipart/form-data']) !!}
              ...
              <div class="form-group">
                  ...
                  <input type="hidden" name="text_id" value="{{$text_details->text_id}}">

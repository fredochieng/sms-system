...
<div class="box with-border">
	...
	<div class="box-body">
		...
		<div class="row">
			...
			<?php if($count == 'M'): ?>
			<div class="col-md-4">
				<?php echo e(Form::label('Select department you are sending the SMS from ')); ?>
			...
			<input type="hidden" name="user_department" class="user_department" value="<?php echo e($dept_id); ?>">
			<?php elseif($count == 'Z'): ?>
			<input type="hidden" name="user_department" class="user_department" value="<?php echo e($dept_id); ?>">
			<?php endif; ?>
		</div>
			...
			<div class="modal-body">
				...
				<form id="form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<?php echo e(Form::checkbox('save_for_future_switch',null,null, array('id'=>'save_for_future_switch'))); ?>

							<?php echo e(Form::label('save_for_future_switch', ' Save The imported contacts for future use')); ?>

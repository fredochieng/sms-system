...
<?php $__env->startSection('title', 'Contact Lists'); ?>
                  	...
                  	<div class="col-md-12">
                    	<?php echo e(Form::label('contacts_title', 'Contact List Title* ')); ?>
                         ...
                         <div class="form-group">
                             <?php echo e(Form::text('contacts_title', '',['class'=>'form-control', 'placeholder'=>'Enter your Contacts List Title','required'=>'required'])); ?>

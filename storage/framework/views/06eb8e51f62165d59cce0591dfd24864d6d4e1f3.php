...
use DB;
 ...
 $user_first_login=DB::table('users')->where('id',Auth::user()->id)->first(); 
$first_reset=$user_first_login->first_login_reset; */
    ...
    <div class="wrapper">
                ...
                <div class="navbar-custom-menu">
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            ...
                            <p style="padding-right:30px; padding-top:15px; color:#E8DDDE">
                            <span style="display:inline"><?php echo e(Auth::user()->name); ?> &nbsp;</span>
                              
                              <span style="display:inline">
                                <a href="#"
                                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="color:#F9F9F9"
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <?php echo $__env->make('adminlte::partials.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </section>
